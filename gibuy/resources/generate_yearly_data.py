...
if __name__ == "__main__":
    ...
    with open("yearly_shabbat_data_5786.txt", "w", encoding="utf-8") as f:
        for entry in shabbat_data:
            f.write(f"{entry},\n")

    # Écriture JSON
    with open("yearly_shabbat_data_5786.json", "w", encoding="utf-8") as fjson:
        json.dump(shabbat_data, fjson, ensure_ascii=False, indent=2)

    print("✅ yearly_shabbat_data_5786.txt et yearly_shabbat_data_5786.json générés.")